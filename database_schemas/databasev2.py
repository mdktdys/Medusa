...
#
# from sqlalchemy import ARRAY, BigInteger, Boolean, Column, Date, DateTime, Double, ForeignKeyConstraint, Identity, Integer, Numeric, PrimaryKeyConstraint, SmallInteger, String, Table, Text, Time, UniqueConstraint, text
...
#     Courses_: Mapped['Courses'] = relationship('Courses', back_populates='Zamenas')
