...
Извлеки пары "ФИО преподавателя – кабинет", где указано, куда он перенесён. Если несколько преподавателей указаны перед одним кабинетом, то каждому из них соответствует этот кабинет. Если замен нет, то верни пустую строку. Не пиши ничего лишнего
Поставь разделитель |.
